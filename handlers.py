...
DAILY_QUOTES = [
    "خذ الأمور خطوة بخطوة، ولا تحمل نفسك أكثر مما تستطيع. 🌱",
    "من حقك أن تطلب المساعدة عندما تحتاجها. 🤝",
    "ليس مطلوباً منك أن تكون قوياً طوال الوقت. 🌿",
    "يوم صعب لا يعني حياة صعبة. ☀️",
    "امنح نفسك الوقت الذي تحتاجه. ⏳",
    "الراحة جزء من التعافي وليست تأخيراً له. 🌸",
    "مشاعرك تستحق أن تُسمع باحترام. 💙",
    "يمكن للأيام الصعبة أن تمر، حتى لو بدت طويلة. 🌤️",
    "الاهتمام بنفسك خطوة مهمة وليست رفاهية. 🌷",
    "التقدم البسيط ما زال تقدماً. 👣",
    "من الطبيعي أن تختلف سرعة التعافي من شخص لآخر. 🌱",
    "ليس عليك أن تواجه كل شيء وحدك. 🤍",
    "كل محاولة للاعتناء بنفسك لها قيمة. 🌿",
    "امنح نفسك بعض اللطف الذي تمنحه للآخرين. 🌸",
    "قد لا ترى التقدم اليوم، لكنه قد يكون موجوداً. ✨",
    "الهدوء أحياناً إنجاز بحد ذاته. 🕊️",
    "لك الحق في أخذ استراحة عندما تحتاجها. 🌼",
    "بعض الأيام تحتاج صبراً أكثر من غيرها. 🌤️",
    "وجود أشخاص داعمين يحدث فرقاً كبيراً. 🤝",
    "غداً يوم جديد يحمل احتمالات جديدة. 🌅"
]
