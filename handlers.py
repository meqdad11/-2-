...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
     "بوت شفق المجموعة نشط ✅\n\n"
        "أوامر المشرفين:\n"
        "حظر / رفع الحظر / تحذير / كتم / رفع الكتم\n"
        "قائمة / معلومات / تحقق / سجل\n"
        "أضف كلمة / احذف كلمة / الكلمات المحظورة\n"
        "أغلق المجموعة / افتح المجموعة\n\n"
        "للجميع:\n"
        "ايدي — معلوماتك الشخصية\n"
        "بحث <اسم> — بحث في يوتيوب وساوند كلاود\n"
        "يوتيوب <اسم> — بحث في يوتيوب"
    )
