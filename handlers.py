...
AUTO_REPLIES = {
    ...
    "شلونك":      ["بخير الحمدلله، وأنت؟ 😊", "تمام، كيف حالك؟"],
    "يسلمو":      ["الله يسلمك 🤍", "يسلم يديك"],
    "شكرا":       ["العفو 😊", "بكل سرور 🤍"],
}

CRISIS_KEYWORDS = [
    "انتحار", "انتحرت", "أنتحر", "بنتحر", "ينتحر",
    "اقتل نفسي", "بقتل نفسي", "يقتل نفسه", "اقتل تفسي", "بقتل تفسي",
    "أذيت", "أذيت نفسي", "اذيت نفسي", "أضر بنفسي", "اضر نفسي",
    "أموت", "بموت", "ابي اموت", "أبي أموت", "ابغى اموت", "أبغى أموت",
    "ما ابي اعيش", "مو قادر على الحياة",
    "اخنق نفسي", "أخنق نفسي",
    "مو قادر", "مو قادره", "تعبت", "مافي فايدة", "ما في فايدة",
    "خلاص", "وداع", "وداعاً", "وداعا",
