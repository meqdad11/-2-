...
async def cmd_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    keyboard = [
        ...
        [InlineKeyboardButton("📋 تذكيراتي", callback_data="menu_my_reminders"),
         InlineKeyboardButton("❌ إلغاء تذكير يومي", callback_data="menu_cancel_daily")],
        [InlineKeyboardButton("📁 ملف", callback_data="menu_file"),
         InlineKeyboardButton("📜 سجل", callback_data="menu_eventlog")],
